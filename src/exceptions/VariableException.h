...
#ifndef NUT_PLUS_PLUS_VARIABLEEXCEPTION_H
#define NUT_PLUS_PLUS_VARIABLEEXCEPTION_H

#include "NUTException.h"

namespace nut {
    class VariableException : public NUTException {
    public:
        using NUTException::NUTException;
    };
}

#endif //NUT_PLUS_PLUS_VARIABLEEXCEPTION_H