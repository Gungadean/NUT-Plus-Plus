...
#ifndef NUT_PLUS_PLUS_CONNECTIONEXCEPTION_H
#define NUT_PLUS_PLUS_CONNECTIONEXCEPTION_H

#include "NUTException.h"

namespace nut {
    class ConnectionException : public NUTException {
    public:
        using NUTException::NUTException;
    };
}

#endif //NUT_PLUS_PLUS_CONNECTIONEXCEPTION_H