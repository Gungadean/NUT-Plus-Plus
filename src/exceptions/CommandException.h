...
#ifndef NUT_PLUS_PLUS_COMMANDEXCEPTION_H
#define NUT_PLUS_PLUS_COMMANDEXCEPTION_H

#include "NUTException.h"

namespace nut {
    class CommandException : public NUTException {
    public:
        using NUTException::NUTException;
    };
}

#endif //NUT_PLUS_PLUS_COMMANDEXCEPTION_H