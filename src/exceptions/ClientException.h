...
#ifndef NUT_PLUS_PLUS_CLIENTEXCEPTION_H
#define NUT_PLUS_PLUS_CLIENTEXCEPTION_H

#include "NUTException.h"

namespace nut {
    class ClientException : public NUTException {
    public:
        using NUTException::NUTException;
    };
}

#endif //NUT_PLUS_PLUS_CLIENTEXCEPTION_H